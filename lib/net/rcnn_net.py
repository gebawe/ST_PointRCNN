...
class RCNNNet(nn.Module):
    def __init__(self, train_eval, num_classes, input_channels=0, use_xyz=True):
        super().__init__()
        ...
        if cfg.RCNN.ROI_SAMPLE_JIT:
            ...
            if self.train_eval:
                ...
                if cfg.RCNN.USE_DEPTH:
                    ...
                    # for pc lidar span of x:-100, 100; y: -100, 100
                    pts_depth = input_data['pts_depth'] / np.max(cfg.PC_AREA_SCOPE) - 0.5
