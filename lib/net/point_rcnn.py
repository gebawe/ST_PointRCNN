...
class PointRCNN(nn.Module):
    def __init__(self, train_eval, num_classes, use_xyz=True, mode='TRAIN'):
        super().__init__()
        ...
        if cfg.RCNN.ENABLED:
            ...
            if cfg.RCNN.BACKBONE == 'pointnet':
                self.rcnn_net = RCNNNet(self.train_eval, num_classes=num_classes, input_channels=rcnn_input_channels, use_xyz=use_xyz)
    ...
    def forward(self, input_data):
        ...
        if cfg.RPN.ENABLED:
            ...
            if cfg.RCNN.ENABLED:
                ...
                if self.train_eval:
                    rcnn_input_info['gt_boxes3d'] = input_data['gt_boxes3d']
                    rcnn_input_info['rcnn_weights'] = input_data['rcnn_weights']                    
