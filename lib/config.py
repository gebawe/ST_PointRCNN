...
__C.DATA_PATH = '/mnt/beegfs/gpu/argoverse-tracking-all-training/KITTI/training'
__C.VAL_DATA_PATH = '/mnt/beegfs/gpu/argoverse-tracking-all-training/KITTI/validation'
...
__C.past_frame = 5
__C.future_frame = 5
__C.label_name = 'label'

__C.PC_AREA_SCOPE = np.array([[0, 70.4],
                              [-3,   3],
                              [-40, 40]])  # x, y, z scope in rect camera coords
...
#__C.TRAIN.RPN_DISTANCE_BASED_PROPOSE = False
...
#__C.TEST.RPN_DISTANCE_BASED_PROPOSE = False
