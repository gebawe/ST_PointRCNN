...
def set_bn_momentum_default(bn_momentum):
    ...
    def fn(m):
        ...
        ###'''
        '''
        if isinstance(m, (nn.GroupNorm1d, nn.GroupNorm2d, nn.GroupNorm3d)):
            m.momentum = bn_momentum
            ...
            for epoch in tbar:
                ...
                if trained_epoch % ckpt_save_interval == 0:
                    if val_loss < val_loss_best:
                        ...
                        ckpt_name = os.path.join(self.ckpt_dir, 'best')
                        save_checkpoint(checkpoint_state(self.model, self.optimizer, trained_epoch, it), filename=ckpt_name,)
