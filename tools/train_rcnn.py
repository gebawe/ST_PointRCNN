...
def create_dataloader(logger):
    ...
    #DATA_PATH = '/datagrid/public_datasets/Awe/Argoverse/Datasets/argoverse_traing_all'
    #DATA_PATH = '/datagrid/public_datasets/Awe/Argoverse/Datasets/argoverse_traing_all_old/all'
    #DATA_PATH = '/datagrid/public_datasets/Awe/Argoverse/Datasets/argoverse_traing_all/processed'
    
    #DATA_PATH = '/mnt/data/vras/data/raw_Argoverse/Datasets/argoverse-tracking-all-training/argoverse-tracking/processed/source/f-1_1/f500/sframe/train'
    #VAL_DATA_PATH = '/mnt/data/vras/data/raw_Argoverse/Datasets/argoverse-tracking-all-training/argoverse-tracking/processed/source/f-1_1/f500/sframe/val'
    ...
    if args.train_with_eval:
        test_set = KittiRCNNDataset(root_dir=VAL_DATA_PATH, npoints=cfg.RPN.NUM_POINTS, split=cfg.TRAIN.VAL_SPLIT, mode='EVAL',
                                    logger=logger,
                                    classes=cfg.CLASSES,
...
if __name__ == "__main__":
    ...
    train_eval = True
    model = PointRCNN(train_eval, num_classes=train_loader.dataset.num_class, use_xyz=True, mode='TRAIN')
